                ...
                <View style={{flexDirection:'row',padding:10,backgroundColor:'#005091',borderBottomEndRadius:20,borderBottomStartRadius:20}}>
                    ...
                    <View style={{width:'75%'}}>
                         ...
                         <View style={{flexDirection:'row'}}>
                             <View style={{width:'50%'}}>
                                <Text style={{color:'#fff', fontFamily:'Roboto-Regular',marginTop:4,fontSize:13}}>Company Name</Text>
                                <Text style={{color:'#fff',fontWeight:'bold', fontFamily:'Roboto-Regular',marginTop:4,fontSize:13}}>{this.props.data.company_name}</Text>
                             </View>
                             <View style={{width:'50%'}}>
                                <Text style={{color:'#fff', fontFamily:'Roboto-Regular',marginTop:4,fontSize:13}}>Completed Trips</Text>
                                <Text style={{color:'#fff',fontWeight:'bold', fontFamily:'Roboto-Regular',marginTop:4,fontSize:13,marginLeft:'40%'}}>{this.state.data.length}</Text>
                             </View>
                         </View>
                     </View>
                </View>
